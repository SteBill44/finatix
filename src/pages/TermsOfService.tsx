  ...
  return (
    <Layout>
      <SEOHead
        ...
        description="The terms and conditions that govern your use of the Finatix CIMA training platform."
        canonicalUrl="/terms"
      />
        ...
        <h1 className="text-4xl font-bold mb-8 uppercase">Terms of <span className="text-gradient-brand">Service</span></h1>
