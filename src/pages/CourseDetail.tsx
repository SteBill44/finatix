        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2">
              ...
              {/* Lessons */}
              <Accordion type="single" collapsible defaultValue="lessons" className="mb-12">
                <AccordionItem value="lessons" className="border border-border rounded-xl bg-card overflow-hidden">
                  ...
                  <AccordionContent className="px-6 pb-6">
                    <div className="space-y-3 pt-2">
                      {lessons && lessons.length > 0 ? (
                        ...
                        <div className="text-center py-12 bg-secondary/50 rounded-xl border border-border">
              ...
              {quizzes && quizzes.filter(q => q.lesson_id).length > 0 && (
                <Accordion type="single" collapsible defaultValue="lesson-quizzes" className="mb-12">
                  <AccordionItem value="lesson-quizzes" className="border border-border rounded-xl bg-card overflow-hidden">
                    <AccordionTrigger className="px-6 py-4 hover:no-underline hover:bg-muted/50">
                      <h2 className="text-2xl font-bold text-foreground flex items-center gap-3">
                        <ClipboardList className="w-6 h-6 text-primary" />
                        Lesson Quizzes
                        <span className="text-sm font-normal text-muted-foreground ml-2">
                          ({quizzes.filter(q => q.lesson_id).length} quizzes)
                        </span>
                      </h2>
                    </AccordionTrigger>
                    <AccordionContent className="px-6 pb-6">
                      <div className="space-y-4 pt-2">
                        {quizzes.filter(q => q.lesson_id).map((quiz) => (
                          <div
                            key={quiz.id}
                            className="bg-secondary/50 rounded-xl border border-border p-6 hover:border-primary/50 transition-colors"
                          >
              ...
              {quizzes && quizzes.filter(q => !q.lesson_id).length > 0 && (
                <Accordion type="single" collapsible defaultValue="mock-exams" className="mb-12">
                  <AccordionItem value="mock-exams" className="border border-accent/30 rounded-xl bg-gradient-to-br from-accent/10 via-primary/5 to-background overflow-hidden">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div className="text-left">
                          ...
                          <p className="text-sm text-muted-foreground font-normal">
                            {quizzes.filter(q => !q.lesson_id).length} exams • Simulate real CIMA conditions
                          </p>
                        </div>
                      </div>
                    </AccordionTrigger>
                    <AccordionContent className="px-6 pb-6">
                      <p className="text-muted-foreground mb-6 pt-2">
              ...
              {isEnrolled && quizAttempts && quizAttempts.length > 0 && quizzes && quizzes.filter(q => !q.lesson_id).length > 0 && (
                <Accordion type="single" collapsible className="mb-12">
                  <AccordionItem value="exam-results" className="border border-border rounded-xl bg-card overflow-hidden">
                    <AccordionTrigger className="px-6 py-4 hover:no-underline hover:bg-muted/50">
                      <h2 className="text-2xl font-bold text-foreground flex items-center gap-3">
              ...
              {isEnrolled && quizAttempts && quizAttempts.length > 0 && (
                <Accordion type="single" collapsible className="mb-12">
                  <AccordionItem value="analytics" className="border border-border rounded-xl bg-card overflow-hidden">
                    <AccordionTrigger className="px-6 py-4 hover:no-underline hover:bg-muted/50">
                      <h2 className="text-2xl font-bold text-foreground flex items-center gap-3">
                    ...
                    <AccordionContent className="px-6 pb-6">
                      <div className="grid lg:grid-cols-5 gap-6 pt-2">
                        ...
                        <Card className="p-4 lg:col-span-3 flex flex-col border-0 shadow-none bg-secondary/30">
                        ...
                        <div className="lg:col-span-2 space-y-6">
                          ...
                          <Card className="p-5 border-0 shadow-none bg-secondary/30">
