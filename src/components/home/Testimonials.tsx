...
const Testimonials = () => {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      initials: "CT",
      quote: "The courses provided by Finatix are the best in terms of content and structure I have come across. An absolute must for anyone wanting to pursue their CIMA certification but also anyone wanting to gain a solid baseline knowledge set for a career in management accounting.",
    },
    {
      name: "Brod K.",
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-charcoal mb-4">
            Trusted by <span className="text-primary">Finance Professionals</span>
          </h2>
