  ...
  ({ studentName, courseName, certificateNumber, issuedAt, className = "" }, ref) => {
    ...
    return (
      ...
      >
        ...
        {/* Content */}
        <AutoFit className="relative z-10 h-full w-full" minScale={0.78} maxScale={1}>
          <div className="flex h-full min-h-0 flex-col items-center justify-between px-2 py-2 sm:px-6 sm:py-5 md:px-10 md:py-7 lg:px-12 lg:py-10">
            {/* Header */}
            ...
            <div className="flex flex-col items-center text-center max-w-2xl flex-1 min-h-0 justify-center overflow-hidden py-2 sm:py-3 md:py-3">
              ...
              <p className="text-gray-500 text-[clamp(0.75rem,1.6vw,1.125rem)] mt-2 sm:mt-3 md:mt-4">
